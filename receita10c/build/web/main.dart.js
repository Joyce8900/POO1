...
define('zapp_user_main', ['dart_sdk', 'flutter_sdk'], (function load__zapp_user_main(dart_sdk, flutter_sdk) {
  ...
  main.Ordenador = class Ordenador extends core.Object {
    ordenarFuderoso(objetos, comparador) {
    ...
    static ['_#new#tearOff']() {
      return new main.Ordenador.new();
    }
  };
  (main.Ordenador.new = function() {
    ;
  }).prototype = main.Ordenador.prototype;
  dart.addTypeTests(main.Ordenador);
  dart.addTypeCaches(main.Ordenador);
  dart.setMethodSignature(main.Ordenador, () => ({
    __proto__: dart.getMethods(main.Ordenador.__proto__),
    ordenarFuderoso: dart.fnType(core.List, [core.List, dart.fnType(core.bool, [dart.dynamic, dart.dynamic])])
  }));
  dart.setLibraryUri(main.Ordenador, I[0]);
  main.DataService = class DataService extends core.Object {
    buscarDadosAleatorios() {
      return async.async(core.List, function* buscarDadosAleatorios() {
        let response = (yield http.get(core.Uri.parse("https://randomuser.me/api/?results=10")));
        if (response.statusCode === 200) {
          let decodedResponse = convert.jsonDecode(response.body);
          return T.FutureOrOfList().as(dart.dsend(decodedResponse, '_get', ["results"]));
        } else {
          dart.throw(core.Exception.new("Falha ao buscar os dados"));
        }
      });
    }
    ordenarEstadoAtual(propriedade, crescente) {
      this.buscarDadosAleatorios().then(core.Null, dart.fn(objetos => {
        if (objetos[$isEmpty]) return;
        let ord = new main.Ordenador.new();
        let comparador = dart.fn((atual, proximo) => {
          try {
            let resultado = core.int.as(dart.dsend(dart.dsend(atual, '_get', [propriedade]), 'compareTo', [dart.dsend(proximo, '_get', [propriedade])]));
        ...
        }, T.dynamicAnddynamicTobool());
        let objetosOrdenados = ord.ordenarFuderoso(objetos, comparador);
        this.emitirEstadoOrdenado(objetosOrdenados, propriedade);
      }, T.ListToNull()));
    }
    emitirEstadoOrdenado(objetosOrdenados, propriedade) {
      core.print("Objetos Ordenados pela propriedade " + propriedade + ":");
      objetosOrdenados[$forEach](dart.fn(objeto => {
        core.print(dart.dsend(objeto, '_get', [propriedade]));
      }, T.dynamicTovoid()));
    }
    static ['_#new#tearOff']() {
  ...
  dart.setMethodSignature(main.DataService, () => ({
    ...
    buscarDadosAleatorios: dart.fnType(async.Future$(core.List), []),
  ...
  main._MyAppState = class _MyAppState extends framework.State$(main.MyApp) {
    ...
    fetchData() {
      return async.async(dart.void, (function* fetchData() {
        let response = (yield http.get(core.Uri.parse("https://randomuser.me/api/?results=10")));
        if (response.statusCode === 200) {
          let decodedResponse = convert.jsonDecode(response.body);
          this.setState(dart.fn(() => {
            this.data = core.List.as(dart.dsend(decodedResponse, '_get', ["results"]));
          }, T.VoidTovoid()));
        } else {
          dart.throw(core.Exception.new("Falha ao buscar os dados"));
        }
    ...
    sortData(propriedade, crescente) {
      let ord = new main.Ordenador.new();
      let comparador = dart.fn((atual, proximo) => {
        try {
          let resultado = core.int.as(dart.dsend(dart.dsend(atual, '_get', [propriedade]), 'compareTo', [dart.dsend(proximo, '_get', [propriedade])]));
      ...
      let objetosOrdenados = ord.ordenarFuderoso(this.data, comparador);
      this.setState(dart.fn(() => {
        this.data = objetosOrdenados;
      }, T.VoidTovoid()));
    }
    build(context) {
      return new app.MaterialApp.new({home: new scaffold.Scaffold.new({appBar: new app_bar.AppBar.new({title: new text.Text.new("Tabela de Dados")}), body: new main.DataTableWidget.new({data: this.data, sortData: dart.bind(this, 'sortData')})})});
    }
    static ['_#new#tearOff']() {
      return new main._MyAppState.new();
    }
  ...
  dart.setMethodSignature(main._MyAppState, () => ({
    ...
    fetchData: dart.fnType(async.Future$(dart.void), []),
    sortData: dart.fnType(dart.void, [core.String, core.bool]),
  ...
  var data$ = dart.privateName(main, "DataTableWidget.data");
  var sortData$ = dart.privateName(main, "DataTableWidget.sortData");
  main.DataTableWidget = class DataTableWidget extends framework.StatelessWidget {
    ...
    set sortData(value) {
      super.sortData = value;
    }
    static ['_#new#tearOff'](opts) {
      let data = opts && 'data' in opts ? opts.data : null;
      let sortData = opts && 'sortData' in opts ? opts.sortData : null;
      return new main.DataTableWidget.new({data: data, sortData: sortData});
    }
    build(context) {
      return new single_child_scroll_view.SingleChildScrollView.new({scrollDirection: basic_types.Axis.horizontal, child: new data_table.DataTable.new({sortAscending: true, sortColumnIndex: 0, columns: T.JSArrayOfDataColumn().of([new data_table.DataColumn.new({label: new text.Text.new("Name"), onSort: dart.fn((columnIndex, ascending) => {
                let t3, t2;
                t2 = "name";
                t3 = ascending;
                this.sortData(t2, t3);
              }, T.intAndboolTovoid())}), new data_table.DataColumn.new({label: new text.Text.new("Age"), onSort: dart.fn((columnIndex, ascending) => {
                let t3, t2;
                t2 = "age";
                t3 = ascending;
                this.sortData(t2, t3);
              }, T.intAndboolTovoid())}), new data_table.DataColumn.new({label: new text.Text.new("Email"), onSort: dart.fn((columnIndex, ascending) => {
                let t3, t2;
                t2 = "email";
                t3 = ascending;
                this.sortData(t2, t3);
              }, T.intAndboolTovoid())})]), rows: this.data[$map](data_table.DataRow, dart.fn(item => new data_table.DataRow.new({cells: T.JSArrayOfDataCell().of([new data_table.DataCell.new(new text.Text.new(core.String.as(dart.dsend(dart.dsend(item, '_get', ["name"]), '_get', ["first"])))), new data_table.DataCell.new(new text.Text.new(dart.toString(dart.dsend(dart.dsend(item, '_get', ["dob"]), '_get', ["age"])))), new data_table.DataCell.new(new text.Text.new(core.String.as(dart.dsend(item, '_get', ["email"]))))])}), T.dynamicToDataRow()))[$toList]()})});
    }
  };
  ...
  dart.setFieldSignature(main.DataTableWidget, () => ({
    ...
    sortData: dart.finalFieldType(dart.fnType(dart.dynamic, [core.String, core.bool]))
  }));
  main.main = function main$0() {
    let dataService = new main.DataService.new();
